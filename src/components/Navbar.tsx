...
import { Menu, X, Facebook, Instagram, FileText, ChevronDown } from 'lucide-react';
...
const navLinks: { label: string; page: NavPage; dropdown?: { label: string; page: NavPage; external?: boolean; href?: string }[] }[] = [
  { label: 'Über uns', page: 'ueber-uns' },
  {
    label: 'Aktuelles', page: 'aktuelles', dropdown: [
      { label: 'Zeitplan', page: 'aktuelles', href: '/Wettbewerbe/Zeitplan-Stand_2026-06-17.pdf' },
      { label: 'Timetable', page: 'aktuelles', href: '/Wettbewerbe/Timetable-2026_Stand_2026-06-17.pdf' },
